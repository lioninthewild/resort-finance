...
const INCOME_COLORS = ["#2563eb", "#8b5cf6", "#ec4899", "#14b8a6", "#f59e0b", "#10b981", "#6366f1", "#06b6d4"];
const EXPENSE_COLORS = ["#dc2626", "#f97316", "#eab308", "#84cc16", "#06b6d4", "#a855f7", "#14b8a6", "#6366f1"];
